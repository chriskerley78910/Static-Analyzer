...
extern EIF_TYPED_VALUE F1352_13163(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1352_13163 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1351, Current, 0, 0, 18843);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1351, Current, 18843);
	RTIV(Current, RTAL);
	RTHOOK(1);
