...
static EIF_TYPED_VALUE F1326_12950_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1326_12950(EIF_REFERENCE);
extern void F1326_16387(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1326_12950_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1325, Current, 0, 0, 18689);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1326_12950 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9307, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1326_12950_body (Current)).it_r;
...
void F1326_16387 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1325, Current, 0, 16386);
	RTSA(dtype);
	RTME(dtype, 0);
