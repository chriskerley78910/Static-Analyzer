...
static EIF_TYPED_VALUE F1353_13066_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1353_13066(EIF_REFERENCE);
extern void F1353_16517(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1353_13066_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1352, Current, 0, 0, 18793);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1352, Current, 18793);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1353_13066 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9390, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1353_13066_body (Current)).it_r;
...
void F1353_16517 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1352, Current, 0, 16516);
	RTSA(dtype);
	RTME(dtype, 0);
