...
extern EIF_TYPED_VALUE F1330_12371(EIF_REFERENCE);
static EIF_TYPED_VALUE F1330_12390_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1330_12390(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1330_12371 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1329, Current, 2, 0, 18226);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1329, Current, 18226);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	loc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9502, dtype))(Current)).it_i4);
	RTHOOK(7);
	...
	loc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9503, dtype))(Current)).it_i4);
	RTHOOK(13);
	RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
	...
	RTHOOK(18);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9499, dtype))(Current)).it_b);
	RTNHOOK(18,1);
...
static EIF_TYPED_VALUE F1330_12390_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1329, Current, 0, 0, 18227);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1329, Current, 18227);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1330_12390 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9390, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1330_12390_body (Current)).it_r;
