...
extern EIF_TYPED_VALUE F1576_8994(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1576_8995(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1576_8997(EIF_REFERENCE);
extern void F1576_9002(EIF_REFERENCE);
extern void F1576_9003(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1576_8994 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1575, Current, 2, 3, 14554);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1575, Current, 14554);
	{
		static EIF_TYPE_INDEX typarr0[] = {1576,0,0xFFFF};
		EIF_TYPE_INDEX typres0;
		typarr0[1] = RTWCT(6882, dtype, Dftype(Current));
		
		typres0 = eif_compound_id(Dftype(Current), typarr0);
		RTCC(arg1, 1575, l_feature_name, 1, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1576_8995 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1575, Current, 0, 0, 14555);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1575, Current, 14555);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1576_8997 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1575, Current, 0, 0, 14556);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1575, Current, 14556);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F1576_9002 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1575, Current, 0, 0, 14557);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1575, Current, 14557);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1576_9003 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1575, Current, 0, 0, 14558);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1575, Current, 14558);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
