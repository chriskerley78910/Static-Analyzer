...
extern EIF_TYPED_VALUE F1178_10634(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1178_10635(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1178_10634 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1177, Current, 0, 0, 16473);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1177, Current, 16473);
	RTIV(Current, RTAL);
...
body:;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8210, dtype))(Current)).it_b);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_TYPED_VALUE F1178_10635 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1177, Current, 0, 1, 16474);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1177, Current, 16474);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
