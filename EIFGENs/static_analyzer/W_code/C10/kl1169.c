...
extern EIF_TYPED_VALUE F1169_10465(EIF_REFERENCE);
...
RTOID (F1169_10465)
EIF_TYPED_VALUE F1169_10465 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1168, Current, 0, 0, 16280);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1168, Current, 16280);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
