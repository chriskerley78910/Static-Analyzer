...
extern void F1044_9401(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1044_9402(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1044_9403(EIF_REFERENCE);
...
/* {ETF_BOOL_ARG}.make */
void F1044_9401 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 1043, Current, 0, 1, 14902);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {ETF_BOOL_ARG}.value */
EIF_TYPED_VALUE F1044_9402 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
/* {ETF_BOOL_ARG}.out */
EIF_TYPED_VALUE F1044_9403 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1043, Current, 0, 0, 14904);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1043, Current, 14904);
	RTIV(Current, RTAL);
	RTHOOK(1);
