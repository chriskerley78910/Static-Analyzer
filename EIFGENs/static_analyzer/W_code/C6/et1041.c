...
#define arg1 arg1x.it_c1
	...
	RTEAA(l_feature_name, 1040, Current, 0, 1, 14891);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1040, Current, 14891);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_REFERENCE *)(Current + RTWA(7179, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7195, 0x08000000, 1); /* value */
	
	*(EIF_CHARACTER_8 *)(Current + RTWA(7195, dtype)) = (EIF_CHARACTER_8) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
EIF_TYPED_VALUE F1041_9398 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
	r.it_c1 = *(EIF_CHARACTER_8 *)(Current + RTWA(7195,Dtype(Current)));
	return r;
}
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1040, Current, 0, 0, 14893);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1040, Current, 14893);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DB, 0,0); /* Result */
	
	tr1 = RTMS_EX_H("\'",1,39);
	tc1 = *(EIF_CHARACTER_8 *)(Current + RTWA(7195, dtype));
	tr2 = c_outc(tc1);
