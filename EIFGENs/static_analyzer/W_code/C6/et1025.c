...
extern void F1025_9337(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1025_9338(EIF_REFERENCE);
...
/* {ETF_ENUM_PARAM}.make */
void F1025_9337 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1024, Current, 0, 1, 14831);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1024, Current, 14831);
	{
		...
		RTCC(arg1, 1024, l_feature_name, 1, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 7157, 0xF80000F9, 0); /* items */
	
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(7157, Dtype(Current))) = (EIF_REFERENCE) RTCCL(arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1025_9338 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1025_9339 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1024, Current, 0, 0, 14833);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1024, Current, 1, 0, 14834);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1024, Current, 14834);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DB, 0,0); /* Result */
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1024, Current, 1, 0, 14835);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1024, Current, 14835);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000DB, 0,0); /* Result */
