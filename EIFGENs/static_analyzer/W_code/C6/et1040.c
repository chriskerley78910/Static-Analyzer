...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1039, Current, 0, 1, 14888);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1039, Current, 14888);
	...
	*(EIF_REFERENCE *)(Current + RTWA(7179, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7193, 0xF80000DB, 0); /* value */
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1039, Current, 0, 0, 14890);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
