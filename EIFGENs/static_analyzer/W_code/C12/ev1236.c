...
extern EIF_TYPED_VALUE F1236_11495(EIF_REFERENCE);
extern void F1236_11496(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1236_11495 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1236_11496 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1235, Current, 0, 0, 17396);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1235, Current, 17396);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8376, 0xF8000560, 0); /* implementation */
