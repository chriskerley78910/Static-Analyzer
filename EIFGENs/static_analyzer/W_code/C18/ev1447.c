...
extern void F1447_14311(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1447_14312(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1447_14313(EIF_REFERENCE);
extern void F1447_14314(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1447_14315(EIF_REFERENCE);
extern void F1447_14316(EIF_REFERENCE);
extern void F1447_14317(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1447_14318(EIF_REFERENCE);
static EIF_TYPED_VALUE F1447_14319_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1447_14319(EIF_REFERENCE);
...
void F1447_14311 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1446, Current, 0, 1, 19725);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1446, Current, 19725);
	RTCC(arg1, 1446, l_feature_name, 1, RTWCT(9390, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
/* {EV_LABEL_IMP}.make */
void F1447_14312 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1446, Current, 2, 0, 19726);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTAOMS(14311,1);
	RTDBGEAA(1446, Current, 19726);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(4,1);
	RTCOMS(tr2,14311,0,"justify",7,1848530809);
	ur1 = tr2;
...
/* {EV_LABEL_IMP}.angle */
EIF_TYPED_VALUE F1447_14313 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL32;
	r.it_r4 = *(EIF_REAL_32 *)(Current + RTWA(10821,Dtype(Current)));
	return r;
}


/* {EV_LABEL_IMP}.set_angle */
void F1447_14314 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 1446, Current, 0, 1, 19728);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1446, Current, 19728);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = *(EIF_POINTER *)(Current + RTWA(10188, dtype));
	up1 = tp1;
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10821, 0x18000000, 1); /* angle */
	
	*(EIF_REAL_32 *)(Current + RTWA(10821, dtype)) = (EIF_REAL_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
void F1447_14315 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1446, Current, 0, 0, 19729);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1446, Current, 19729);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F1447_14316 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1446, Current, 0, 0, 19730);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1446, Current, 19730);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F1447_14317 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1446, Current, 0, 0, 19731);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1446, Current, 19731);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1447_14318 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
static EIF_TYPED_VALUE F1447_14319_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1446, Current, 0, 0, 19733);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1446, Current, 19733);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1447_14319 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9390, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1447_14319_body (Current)).it_r;
