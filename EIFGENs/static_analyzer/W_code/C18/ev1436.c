...
extern EIF_TYPED_VALUE F1436_14039(EIF_REFERENCE);
extern void F1436_14044(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1436_14045(EIF_REFERENCE);
static EIF_TYPED_VALUE F1436_14046_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1436_14046(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1436_14039 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1435, Current, 1, 0, 19526);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1435, Current, 19526);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		RTNHOOK(5,2);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8754, "is_selected", tr2))(tr2)).it_b);
...
void F1436_14044 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1435, Current, 0, 0, 19523);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1435, Current, 19523);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 10671, 0x04000000, 1); /* default_key_processing_disabled */
	
	*(EIF_BOOLEAN *)(Current + RTWA(10671, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1436_14045 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
/* {EV_LIST_I}.interface */
static EIF_TYPED_VALUE F1436_14046_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1435, Current, 0, 0, 19525);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1435, Current, 19525);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1436_14046 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9390, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1436_14046_body (Current)).it_r;
