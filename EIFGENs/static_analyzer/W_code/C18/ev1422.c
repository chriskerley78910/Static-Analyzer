...
extern void F1422_14205(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1422_14206(EIF_REFERENCE);
static EIF_TYPED_VALUE F1422_14207_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1422_14207(EIF_REFERENCE);
...
void F1422_14205 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1421, Current, 0, 1, 19630);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1421, Current, 19630);
	RTCC(arg1, 1421, l_feature_name, 1, RTWCT(9307, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
void F1422_14206 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1421, Current, 1, 0, 19631);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1421, Current, 19631);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9302, 1420))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
static EIF_TYPED_VALUE F1422_14207_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1421, Current, 0, 0, 19632);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1421, Current, 19632);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1422_14207 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9307, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1422_14207_body (Current)).it_r;
