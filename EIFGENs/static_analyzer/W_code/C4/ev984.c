...
static EIF_TYPED_VALUE F984_8909_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F984_8909(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 983, Current, 0, 0, 14481);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(983, Current, 14481);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6795, 0xF800045C, 0); /* new_item_actions_internal */
...
static EIF_TYPED_VALUE F984_8909_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 983, Current, 0, 0, 14482);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(983, Current, 14482);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F984_8909 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6795, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F984_8909_body (Current)).it_r;
