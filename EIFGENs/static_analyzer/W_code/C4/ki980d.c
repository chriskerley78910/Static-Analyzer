...
static struct desc_info desc_980[] = {
	...
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 219, gen_type13_980},
...
void Init980(void)
{
	...
	IDSC(desc_980 + 32, 810, 979);
	IDSC(desc_980 + 43, 695, 979);
}
