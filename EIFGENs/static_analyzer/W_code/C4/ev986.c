...
static EIF_TYPED_VALUE F986_8908_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F986_8908(EIF_REFERENCE);
extern EIF_TYPED_VALUE F986_8909(EIF_REFERENCE);
static EIF_TYPED_VALUE F986_8911_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F986_8911(EIF_REFERENCE);
extern EIF_TYPED_VALUE F986_8912(EIF_REFERENCE);
static EIF_TYPED_VALUE F986_8914_body(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6792, 0xF800044C, 0); /* maximize_actions_internal */
...
static EIF_TYPED_VALUE F986_8908_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F986_8908 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6792, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F986_8908_body (Current)).it_r;
...
#define up1 up1x.it_p
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6795, 0xF800044C, 0); /* minimize_actions_internal */
...
static EIF_TYPED_VALUE F986_8911_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F986_8911 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6795, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F986_8911_body (Current)).it_r;
...
EIF_TYPED_VALUE F986_8912 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 14490);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 14490);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6798, 0xF800044C, 0); /* restore_actions_internal */
...
static EIF_TYPED_VALUE F986_8914_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 14491);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(985, Current, 14491);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F986_8914 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6798, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F986_8914_body (Current)).it_r;
