...
extern EIF_TYPED_VALUE F986_8911(EIF_REFERENCE);
static EIF_TYPED_VALUE F986_8913_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F986_8913(EIF_REFERENCE);
extern EIF_TYPED_VALUE F986_8914(EIF_REFERENCE);
static EIF_TYPED_VALUE F986_8916_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F986_8916(EIF_REFERENCE);
extern EIF_TYPED_VALUE F986_8917(EIF_REFERENCE);
static EIF_TYPED_VALUE F986_8919_body(EIF_REFERENCE);
...
EIF_TYPED_VALUE F986_8911 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 14484);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 14484);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6798, 0xF8000466, 0); /* maximize_actions_internal */
...
static EIF_TYPED_VALUE F986_8913_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 14485);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(985, Current, 14485);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F986_8913 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6798, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F986_8913_body (Current)).it_r;
...
EIF_TYPED_VALUE F986_8914 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 14486);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 14486);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6801, 0xF8000466, 0); /* minimize_actions_internal */
	...
	Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6801, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("not_void", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
static EIF_TYPED_VALUE F986_8916_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 14487);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(985, Current, 14487);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F986_8916 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6801, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F986_8916_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(6801,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 14488);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 14488);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6804, 0xF8000466, 0); /* restore_actions_internal */
	...
	Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6804, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("not_void", EX_POST);
		if ((EIF_BOOLEAN)(Result != NULL)) {
...
static EIF_TYPED_VALUE F986_8919_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 14489);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(985, Current, 14489);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F986_8919 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6804, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F986_8919_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(6804,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
