...
extern EIF_TYPED_VALUE F959_8823(EIF_REFERENCE);
...
EIF_TYPED_VALUE F959_8821 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 958, Current, 0, 0, 14427);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(958, Current, 14427);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F959_8822 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 958, Current, 0, 0, 14428);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(958, Current, 14428);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000466, 0,0); /* Result */
...
EIF_TYPED_VALUE F959_8823 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 958, Current, 0, 0, 14429);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(958, Current, 14429);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000466, 0,0); /* Result */
...
EIF_TYPED_VALUE F959_8824 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 958, Current, 0, 0, 14430);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(958, Current, 14430);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000466, 0,0); /* Result */
