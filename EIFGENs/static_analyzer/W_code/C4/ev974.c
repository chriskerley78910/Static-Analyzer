...
extern EIF_TYPED_VALUE F974_8864(EIF_REFERENCE);
extern EIF_TYPED_VALUE F974_8865(EIF_REFERENCE);
extern EIF_TYPED_VALUE F974_8866(EIF_REFERENCE);
...
EIF_TYPED_VALUE F974_8864 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 973, Current, 0, 0, 14464);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(973, Current, 14464);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F974_8865 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 973, Current, 0, 0, 14465);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(973, Current, 14465);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F974_8866 (EIF_REFERENCE Current)
{
	GTCX
