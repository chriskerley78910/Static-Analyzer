...
extern EIF_TYPED_VALUE F965_8843(EIF_REFERENCE);
...
EIF_TYPED_VALUE F965_8843 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 964, Current, 0, 0, 14442);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(964, Current, 14442);
	RTIV(Current, RTAL);
	RTHOOK(1);
