...
extern EIF_TYPED_VALUE F972_8859(EIF_REFERENCE);
...
EIF_TYPED_VALUE F972_8859 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 971, Current, 0, 0, 14454);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(971, Current, 14454);
	RTIV(Current, RTAL);
	RTHOOK(1);
