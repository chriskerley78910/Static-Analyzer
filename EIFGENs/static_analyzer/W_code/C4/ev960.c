...
static EIF_TYPED_VALUE F960_8827_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_8827(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_8828(EIF_REFERENCE);
static EIF_TYPED_VALUE F960_8830_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_8830(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 959, Current, 0, 0, 14431);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(959, Current, 14431);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6726, 0xF8000466, 0); /* select_actions_internal */
...
static EIF_TYPED_VALUE F960_8827_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 959, Current, 0, 0, 14432);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(959, Current, 14432);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F960_8827 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6726, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F960_8827_body (Current)).it_r;
...
#define up1 up1x.it_p
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6729, 0xF8000466, 0); /* deselect_actions_internal */
...
static EIF_TYPED_VALUE F960_8830_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F960_8830 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6729, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F960_8830_body (Current)).it_r;
