...
extern EIF_TYPED_VALUE F962_8828(EIF_REFERENCE);
static EIF_TYPED_VALUE F962_8830_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F962_8830(EIF_REFERENCE);
...
EIF_TYPED_VALUE F962_8828 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 14439);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(961, Current, 14439);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6726, 0xF8000445, 0); /* expose_actions_internal */
...
static EIF_TYPED_VALUE F962_8830_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 14440);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(961, Current, 14440);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F962_8830 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6726, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F962_8830_body (Current)).it_r;
