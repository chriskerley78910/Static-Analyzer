...
extern EIF_TYPED_VALUE F976_8875(EIF_REFERENCE);
...
EIF_TYPED_VALUE F976_8875 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 975, Current, 0, 0, 14466);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(975, Current, 14466);
	RTIV(Current, RTAL);
	RTHOOK(1);
