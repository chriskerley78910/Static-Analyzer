...
static EIF_TYPED_VALUE F966_8846_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F966_8846(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 965, Current, 0, 0, 14443);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6741, 0xF8000466, 0); /* selection_actions_internal */
...
static EIF_TYPED_VALUE F966_8846_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 965, Current, 0, 0, 14444);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F966_8846 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6741, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F966_8846_body (Current)).it_r;
