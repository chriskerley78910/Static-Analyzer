...
extern EIF_TYPED_VALUE F980_8895(EIF_REFERENCE);
...
RTOID (F980_8895)
EIF_TYPED_VALUE F980_8895 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 979, Current, 0, 0, 14470);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(979, Current, 14470);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
