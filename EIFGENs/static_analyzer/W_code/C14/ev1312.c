...
static EIF_TYPED_VALUE F1312_12499_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1312_12499(EIF_REFERENCE);
extern void F1312_16382(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1312_12499_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1311, Current, 0, 0, 18287);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1311, Current, 18287);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1312_12499 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9307, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1312_12499_body (Current)).it_r;
...
void F1312_16382 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1311, Current, 0, 16381);
	RTSA(dtype);
	RTME(dtype, 0);
