...
extern EIF_TYPED_VALUE F1196_10581(EIF_REFERENCE);
...
RTOID (F1196_10581)
EIF_TYPED_VALUE F1196_10581 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1195, Current, 0, 0, 16385);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1195, Current, 16385);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
