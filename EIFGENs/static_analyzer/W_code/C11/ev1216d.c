...
static EIF_TYPE_INDEX gen_type13_1216 [] = {0xFF11,1333,0xFFFF};
static EIF_TYPE_INDEX gen_type14_1216 [] = {0xFF11,1312,0xFFFF};


static struct desc_info desc_1216[] = {
	{(BODY_INDEX) 17076, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
...
void Init1216(void)
{
	...
	IDSC(desc_1216 + 32, 474, 1215);
	IDSC(desc_1216 + 47, 953, 1215);
}
