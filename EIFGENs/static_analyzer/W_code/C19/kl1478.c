...
extern EIF_TYPED_VALUE F1478_15213(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1478_15213 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1477, Current, 0, 0, 20542);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1477, Current, 20542);
	RTIV(Current, RTAL);
	RTHOOK(1);
