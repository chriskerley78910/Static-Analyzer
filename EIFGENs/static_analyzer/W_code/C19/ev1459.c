...
extern EIF_TYPED_VALUE F1459_14601(EIF_REFERENCE);
static EIF_TYPED_VALUE F1459_14604_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1459_14604(EIF_REFERENCE);
...
/* {EV_ITEM_I}.parent */
EIF_TYPED_VALUE F1459_14601 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1458, Current, 1, 0, 20011);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1458, Current, 20011);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		{
			static EIF_TYPE_INDEX typarr0[] = {1554,0xFF11,1291,0xFFFF};
...
/* {EV_ITEM_I}.interface */
static EIF_TYPED_VALUE F1459_14604_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1458, Current, 0, 0, 20012);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1458, Current, 20012);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1459_14604 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9390, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1459_14604_body (Current)).it_r;
