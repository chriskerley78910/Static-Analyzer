...
extern EIF_TYPED_VALUE F1473_14739(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1473_14742(EIF_REFERENCE);
static EIF_TYPED_VALUE F1473_14743_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1473_14743(EIF_REFERENCE);
...
/* {EV_MENU_I}.parent */
EIF_TYPED_VALUE F1473_14739 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1472, Current, 1, 0, 20143);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1472, Current, 20143);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		Result = RTCCL(tr1);
		Result = RTRV(eif_non_attached_type(1316), Result);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
EIF_TYPED_VALUE F1473_14742 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1472, Current, 4, 0, 20144);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1472, Current, 20144);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
	...
	loc4 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9985, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(2);
	...
	for (;;) {
		...
		if ((EIF_BOOLEAN)(loc3 != NULL)) {
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8716, "is_selected", loc3))(loc3)).it_b);
...
/* {EV_MENU_I}.interface */
static EIF_TYPED_VALUE F1473_14743_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1472, Current, 0, 0, 20145);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1472, Current, 20145);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1473_14743 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9390, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1473_14743_body (Current)).it_r;
