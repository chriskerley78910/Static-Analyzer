...
extern void F1370_13446(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1370_13447_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1370_13447(EIF_REFERENCE);
...
void F1370_13446 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1369, Current, 1, 1, 19067);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19067);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1370_13447_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1369, Current, 0, 0, 19068);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1369, Current, 19068);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1370_13447 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9307, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1370_13447_body (Current)).it_r;
