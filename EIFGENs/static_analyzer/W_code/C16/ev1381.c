...
extern void F1381_13546(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1381_13547(EIF_REFERENCE);
static EIF_TYPED_VALUE F1381_13548_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1381_13548(EIF_REFERENCE);
...
void F1381_13546 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1380, Current, 0, 1, 19148);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1380, Current, 19148);
	RTCC(arg1, 1380, l_feature_name, 1, RTWCT(9307, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
void F1381_13547 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1380, Current, 0, 0, 19146);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1380, Current, 19146);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9302, 1378))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
static EIF_TYPED_VALUE F1381_13548_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1380, Current, 0, 0, 19147);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1380, Current, 19147);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1381_13548 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9307, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1381_13548_body (Current)).it_r;
