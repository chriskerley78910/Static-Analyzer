...
extern EIF_TYPED_VALUE F1092_10041(EIF_REFERENCE);
...
RTOID (F1092_10041)
EIF_TYPED_VALUE F1092_10041 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1091, Current, 0, 0, 15661);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1091, Current, 15661);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
