...
extern void F1111_10259(EIF_REFERENCE);
...
extern EIF_REFERENCE _A1111_151_2();
extern EIF_REFERENCE _A1111_152_2();
...
void F1111_10259 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1110, Current, 0, 0, 16044);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(32, 1562))(Current);
	RTHOOK(2);
	...
	*((EIF_INTEGER_32 *)tr4+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	
	{
		...
		typres0 = eif_compound_id(dftype, typarr0);
		tr5 = RTLNRW(typres0, 0, (EIF_POINTER) _A1111_151_2, (EIF_POINTER)(0),7913, tr3, 0, 1, -1, tr2, 1);
	}
	ur1 = RTCCL(tr5);
	...
	*((EIF_INTEGER_32 *)tr4+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	
	{
		...
		typres0 = eif_compound_id(dftype, typarr0);
		tr5 = RTLNRW(typres0, 0, (EIF_POINTER) _A1111_152_2, (EIF_POINTER)(0),7914, tr3, 0, 1, -1, tr2, 1);
	}
	ur1 = RTCCL(tr5);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1705, "extend", tr1))(tr1, ur1x);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1110, Current, 1, 1, 16045);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1110, Current, 16045);
	RTCC(arg1, 1110, l_feature_name, 1, eif_attached_type(RTWCT(1741, dtype, Dftype(Current))));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		if ((EIF_BOOLEAN)(arg1 != NULL)) {
			...
			if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
				ur1 = RTCCL(arg1);
				tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7915, dtype))(Current, ur1x)).it_b);
				tb2 = (EIF_BOOLEAN) !tb3;
			}
			tb1 = tb2;
		}
...
body:;
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		RTHOOK(5);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(9657, "enable_parented", loc1))(loc1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1110, Current, 1, 1, 16042);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1110, Current, 16042);
	RTCC(arg1, 1110, l_feature_name, 1, eif_attached_type(RTWCT(1741, Dtype(Current), Dftype(Current))));
	RTIV(Current, RTAL);
	RTHOOK(1);
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		RTHOOK(2);
		...
		RTHOOK(4);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(9658, "disable_parented", loc1))(loc1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1110, Current, 1, 1, 16043);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
