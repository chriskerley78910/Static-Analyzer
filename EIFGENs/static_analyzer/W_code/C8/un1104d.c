...
static EIF_TYPE_INDEX gen_type13_1104 [] = {0xFF11,258,0xFF11,1078,0xFFFF};
static EIF_TYPE_INDEX gen_type14_1104 [] = {0xFF11,245,0xFF11,1078,0xFFFF};
static EIF_TYPE_INDEX gen_type15_1104 [] = {0xFF11,1078,0xFFFF};
static EIF_TYPE_INDEX gen_type16_1104 [] = {0xFF11,1078,0xFFFF};
...
void Init1104(void)
{
	...
	IDSC(desc_1104 + 32, 394, 1103);
	IDSC(desc_1104 + 35, 98, 1103);
	IDSC(desc_1104 + 37, 380, 1103);
	IDSC(desc_1104 + 38, 364, 1103);
	IDSC(desc_1104 + 41, 363, 1103);
}
