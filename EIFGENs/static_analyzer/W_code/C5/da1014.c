...
extern EIF_TYPED_VALUE F1014_9231(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1014_9231 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1013, Current, 0, 0, 14753);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1013, Current, 14753);
	RTIV(Current, RTAL);
	RTHOOK(1);
