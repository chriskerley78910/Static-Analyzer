...
extern EIF_TYPED_VALUE F995_8986(EIF_REFERENCE);
...
EIF_TYPED_VALUE F995_8986 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 14555);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(994, Current, 14555);
	RTIV(Current, RTAL);
	RTHOOK(1);
