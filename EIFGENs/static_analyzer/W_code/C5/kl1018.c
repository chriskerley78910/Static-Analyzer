...
extern EIF_TYPED_VALUE F1018_9318(EIF_REFERENCE);
...
RTOID (F1018_9318)
EIF_TYPED_VALUE F1018_9318 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1017, Current, 0, 0, 14821);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1017, Current, 14821);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
