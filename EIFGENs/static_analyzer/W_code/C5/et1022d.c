...
static struct desc_info desc_1022[] = {
	...
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 219, gen_type13_1022},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 219, gen_type14_1022},
};
