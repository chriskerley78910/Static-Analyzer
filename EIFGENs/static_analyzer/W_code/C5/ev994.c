...
static EIF_TYPED_VALUE F994_8987_body(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 993, Current, 0, 0, 14551);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(993, Current, 14551);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6866, 0xF8000466, 0); /* select_actions_internal */
		...
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(6866, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	}
	RTHOOK(3);
...
static EIF_TYPED_VALUE F994_8987_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 993, Current, 0, 0, 14552);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(993, Current, 14552);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F994_8987 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6866, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F994_8987_body (Current)).it_r;
