...
extern EIF_TYPED_VALUE F1401_13884(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1401_13885(EIF_REFERENCE);
extern void F1401_13893(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1401_13894_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1401_13894(EIF_REFERENCE);
extern void F1401_16397(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1401_13884 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1401_13885 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1400, Current, 2, 0, 19407);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1400, Current, 19407);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1401_13893 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1400, Current, 2, 1, 19404);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1400, Current, 19404);
	RTIV(Current, RTAL);
...
static EIF_TYPED_VALUE F1401_13894_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1400, Current, 0, 0, 19405);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1400, Current, 19405);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1401_13894 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9307, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1401_13894_body (Current)).it_r;
...
void F1401_16397 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1400, Current, 0, 16396);
	RTSA(dtype);
	RTME(dtype, 0);
