...
extern void F1407_13659(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1407_13660(EIF_REFERENCE);
static EIF_TYPED_VALUE F1407_13661_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1407_13661(EIF_REFERENCE);
...
void F1407_13659 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1406, Current, 0, 1, 19248);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1406, Current, 19248);
	RTCC(arg1, 1406, l_feature_name, 1, RTWCT(9390, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
void F1407_13660 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1406, Current, 0, 0, 19249);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1406, Current, 19249);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1407_13661_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1406, Current, 0, 0, 19250);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1406, Current, 19250);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1407_13661 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9390, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1407_13661_body (Current)).it_r;
