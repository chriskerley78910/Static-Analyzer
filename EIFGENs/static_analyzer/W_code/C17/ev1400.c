...
extern void F1400_13584(EIF_REFERENCE);
extern void F1400_13585(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1400_13586(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1400_13587(EIF_REFERENCE);
static EIF_TYPED_VALUE F1400_13588_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1400_13588(EIF_REFERENCE);
...
void F1400_13584 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1399, Current, 0, 0, 19184);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1399, Current, 19184);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9385, 1395))(Current);
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9385, 1572))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
void F1400_13585 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1399, Current, 1, 2, 19185);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1399, Current, 19185);
	RTCC(arg1, 1399, l_feature_name, 1, eif_attached_type(RTWCT(10353, dtype, Dftype(Current))));
	RTIV(Current, RTAL);
...
void F1400_13586 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1399, Current, 2, 1, 19186);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1399, Current, 19186);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("i_within_bounds", EX_PRE);
...
body:;
	...
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		...
		*(EIF_INTEGER_32 *)(Current + RTWA(9984, dtype)) = (EIF_INTEGER_32) loc2;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(11);
...
EIF_TYPED_VALUE F1400_13587 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1399, Current, 0, 0, 19187);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1399, Current, 19187);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x40000000, 1,0); /* Result */
	
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10376, Dtype(Current)))(Current)).it_p);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
static EIF_TYPED_VALUE F1400_13588_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1399, Current, 0, 0, 19188);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1399, Current, 19188);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1400_13588 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9390, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1400_13588_body (Current)).it_r;
