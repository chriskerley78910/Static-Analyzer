...
extern EIF_TYPED_VALUE F1403_13624(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1403_13625(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1403_13626(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1403_13638(EIF_REFERENCE);
static EIF_TYPED_VALUE F1403_13639_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1403_13639(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1403_13624 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F1403_13625 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1403_13626 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
...
EIF_TYPED_VALUE F1403_13638 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1402, Current, 6, 0, 19227);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1402, Current, 19227);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	loc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10432, dtype))(Current)).it_i4);
	RTHOOK(4);
	tb1 = '\0';
	...
	if (tb1) {
		...
		if (tb1) {
			...
			Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10351, dtype))(Current)).it_i4);
			...
			if ((EIF_BOOLEAN) (loc2 < ti4_1)) {
				...
				loc4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10425, dtype))(Current)).it_i4);
				for (;;) {
					RTHOOK(11);
					...
					if ((EIF_BOOLEAN) ((EIF_BOOLEAN) (loc2 >= loc4) && (EIF_BOOLEAN) (loc2 <= loc3))) {
						...
						loc6 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10426, dtype))(Current)).it_i4);
						...
						if ((EIF_BOOLEAN) (loc2 > loc6)) {
							...
							Result = *(EIF_INTEGER_32 *)(Current + RTWA(9984, dtype));
							Result = (EIF_INTEGER_32) (EIF_INTEGER_32) (Result + ((EIF_INTEGER_32) 1L));
						} else {
							RTHOOK(21);
							RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
/* {EV_BOX_I}.interface */
static EIF_TYPED_VALUE F1403_13639_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1402, Current, 0, 0, 19228);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1402, Current, 19228);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1403_13639 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9390, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1403_13639_body (Current)).it_r;
