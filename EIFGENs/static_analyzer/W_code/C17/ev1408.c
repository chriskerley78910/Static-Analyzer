...
extern void F1408_13662(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1408_13663(EIF_REFERENCE);
static EIF_TYPED_VALUE F1408_13664_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1408_13664(EIF_REFERENCE);
...
void F1408_13662 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1407, Current, 0, 1, 19251);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1407, Current, 19251);
	RTCC(arg1, 1407, l_feature_name, 1, RTWCT(9390, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
void F1408_13663 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1407, Current, 0, 0, 19252);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1407, Current, 19252);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9385, 1405))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
static EIF_TYPED_VALUE F1408_13664_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1407, Current, 0, 0, 19253);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1407, Current, 19253);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1408_13664 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9390, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1408_13664_body (Current)).it_r;
