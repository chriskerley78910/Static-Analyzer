...
extern EIF_TYPED_VALUE F916_8486(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F916_8486 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_c1
	...
	RTEAA(l_feature_name, 915, Current, 0, 1, 14133);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(915, Current, 14133);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define up1 up1x.it_p
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6405, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(1,1);
		ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6338, "minimum_character_code", tr1))(tr1)).it_i4);
