...
extern EIF_TYPED_VALUE F902_8415(EIF_REFERENCE);
...
RTOID (F902_8415)
EIF_TYPED_VALUE F902_8415 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 901, Current, 0, 0, 14073);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(901, Current, 14073);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
