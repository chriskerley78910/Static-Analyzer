...
extern EIF_TYPED_VALUE F893_8311(EIF_REFERENCE);
...
RTOID (F893_8311)
EIF_TYPED_VALUE F893_8311 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 892, Current, 0, 0, 13987);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(892, Current, 13987);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
