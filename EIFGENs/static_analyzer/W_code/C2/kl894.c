...
extern EIF_TYPED_VALUE F894_8312(EIF_REFERENCE);
...
RTOID (F894_8312)
EIF_TYPED_VALUE F894_8312 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 893, Current, 0, 0, 13988);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(893, Current, 13988);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
