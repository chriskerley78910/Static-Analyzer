...
extern EIF_TYPED_VALUE F898_8333(EIF_REFERENCE);
extern EIF_TYPED_VALUE F898_8334(EIF_REFERENCE);
static EIF_TYPED_VALUE F898_8336_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F898_8336(EIF_REFERENCE);
static EIF_TYPED_VALUE F898_8338_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F898_8338(EIF_REFERENCE);
...
EIF_TYPED_VALUE F898_8333 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 897, Current, 0, 0, 14009);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(897, Current, 14009);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6264, 0xF8000466, 0); /* select_actions_internal */
		...
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(6264, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	}
	RTHOOK(3);
	RTDBGAL(Current, 0, 0xF8000466, 0,0); /* Result */
	
	Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6264, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
#define up1 up1x.it_p
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6266, 0xF8000466, 0); /* drop_down_actions_internal */
...
static EIF_TYPED_VALUE F898_8336_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F898_8336 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6264, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F898_8336_body (Current)).it_r;
...
static EIF_TYPED_VALUE F898_8338_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F898_8338 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6266, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F898_8338_body (Current)).it_r;
