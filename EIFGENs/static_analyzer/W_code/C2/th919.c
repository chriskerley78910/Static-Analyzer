...
#ifndef INLINE_F919_8556
static EIF_POINTER inline_F919_8556 (void)
{
	return eif_thr_thread_id();
	;
}
#define INLINE_F919_8556
#endif
...
EIF_TYPED_VALUE F919_8556 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 918, Current, 0, 0, 14209);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(918, Current, 14209);
	RTIV(Current, RTAL);
	Result = inline_F919_8556 ();
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
	RTDBGLE;
