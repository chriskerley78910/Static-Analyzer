...
extern void F1277_11825(EIF_REFERENCE);
...
void F1277_11825 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1276, Current, 0, 0, 17714);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1276, Current, 17714);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(8463, 1275))(Current);
	RTHOOK(3);
