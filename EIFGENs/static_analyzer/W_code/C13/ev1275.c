...
extern EIF_TYPED_VALUE F1275_11932(EIF_REFERENCE);
extern void F1275_11933(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1275_11932 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1275_11933 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1274, Current, 0, 0, 17834);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1274, Current, 17834);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8376, 0xF80005A4, 0); /* implementation */
