...
extern void F1492_15468(EIF_REFERENCE);
extern void F1492_15469(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1492_15470(EIF_REFERENCE);
...
void F1492_15468 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1491, Current, 5, 0, 20742);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1491, Current, 20742);
	RTIV(Current, RTAL);
...
void F1492_15469 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1491, Current, 0, 0, 20740);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1491, Current, 20740);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
		...
		if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) '\015')) {
			...
			if ((EIF_BOOLEAN) !tb1) {
				...
				if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) '\012')) {
					...
					tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(11358, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
					RTNHOOK(10,1);
					tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8209, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
					ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1492_15470 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1492_15470,20742,RTMS_EX_H("\015\012",2,3338));
}

void EIF_Minit1492 (void)
{
	GTCX
	RTOTS (15470,F1492_15470)
}
