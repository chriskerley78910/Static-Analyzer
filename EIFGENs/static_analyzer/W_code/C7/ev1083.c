...
extern EIF_TYPED_VALUE F1083_9887(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1083_9887 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1082, Current, 0, 0, 15367);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1082, Current, 15367);
	RTIV(Current, RTAL);
