...
extern EIF_TYPED_VALUE F1084_9888(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1084_9888 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1083, Current, 0, 0, 15368);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1083, Current, 15368);
	RTIV(Current, RTAL);
