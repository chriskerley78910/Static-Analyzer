...
extern void F1077_10025(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1077_10026(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1077_10027(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1077_10028(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1077_10029(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1077_10025 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1076, Current, 0, 0, 15675);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1076, Current, 15675);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7745, 0xF8000524, 0); /* application_i */
	...
	*(EIF_REFERENCE *)(Current + RTWA(7745, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7748, 0xF8000085, 0); /* internal_helper */
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1076, Current, 0, 0, 15676);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1076, Current, 15676);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80004B7, 0,0); /* Result */
	
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7745, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
EIF_TYPED_VALUE F1077_10027 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1076, Current, 1, 1, 15678);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1076, Current, 15678);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTCT0(NULL, EX_CHECK);
...
EIF_TYPED_VALUE F1077_10029 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1076, Current, 4, 1, 15679);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1076, Current, 15679);
	RTCC(arg1, 1076, l_feature_name, 1, eif_attached_type(216));
	RTIV(Current, RTAL);
	RTHOOK(1);
