...
extern EIF_TYPED_VALUE F882_8266(EIF_REFERENCE);
...
extern void F882_8270(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F882_8271(EIF_REFERENCE);
...
EIF_TYPED_VALUE F882_8266 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(6193,Dtype(Current)));
	return r;
}
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 881, Current, 1, 0, 13948);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(881, Current, 13948);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6195, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
void F882_8270 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 881, Current, 2, 1, 13949);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6195, 0xF800010D, 0); /* items */
	...
	*(EIF_REFERENCE *)(Current + RTWA(6195, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6194, 0xF80000DB, 0); /* error_string */
	
	tr1 = RTLNSMART(eif_non_attached_type(RTWCT(6194, dtype, Dftype(Current))));
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(4330, Dtype(tr1)))(tr1);
	...
	*(EIF_REFERENCE *)(Current + RTWA(6194, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	...
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 6193, 0x04000000, 1); /* error */
		
		*(EIF_BOOLEAN *)(Current + RTWA(6193, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		RTHOOK(6);
		RTDBGAA(Current, dtype, 6194, 0xF80000DB, 0); /* error_string */
	...
	if (RTAL & CK_ENSURE) {
		...
		RTCT(NULL, EX_POST);
		tb2 = '\01';
		tb3 = *(EIF_BOOLEAN *)(Current + RTWA(6193, dtype));
		if (tb3) {
			tb3 = '\0';
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6195, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(16,1);
...
void F882_8271 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 881, Current, 1, 0, 13950);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
