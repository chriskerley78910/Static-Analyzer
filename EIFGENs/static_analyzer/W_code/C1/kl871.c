...
#define Result RTOTRR
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6874, "is_open_read", Result))(Result)).it_b);
...
#define Result RTOTRR
	...
	tr1 = RTLN(1523);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11453, Dtype(tr1)))(tr1);
...
#define Result RTOTRR
	...
	tr1 = RTLN(1522);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11452, Dtype(tr1)))(tr1);
