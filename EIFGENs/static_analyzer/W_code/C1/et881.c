...
extern EIF_TYPED_VALUE F881_8265(EIF_REFERENCE);
extern void F881_16447(EIF_REFERENCE, int);
...
/* {ETF_MODEL_ACCESS}.m */
RTOID (F881_8265)
EIF_TYPED_VALUE F881_8265 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	tr1 = RTLN(878);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(6175, Dtype(tr1)))(tr1);
...
void F881_16447 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 880, Current, 0, 16446);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT(NULL, Current);
