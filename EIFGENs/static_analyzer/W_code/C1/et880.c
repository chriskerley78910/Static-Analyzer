...
extern void F880_16447(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 879, Current, 0, 0, 13942);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(879, Current, 13942);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F880_16447 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 879, Current, 0, 16446);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT(NULL, Current);
