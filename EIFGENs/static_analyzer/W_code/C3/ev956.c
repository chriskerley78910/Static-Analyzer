...
static EIF_TYPED_VALUE F956_8803_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F956_8803(EIF_REFERENCE);
extern EIF_TYPED_VALUE F956_8804(EIF_REFERENCE);
static EIF_TYPED_VALUE F956_8806_body(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6708, 0xF8000466, 0); /* drop_down_actions_internal */
...
static EIF_TYPED_VALUE F956_8803_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F956_8803 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6708, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F956_8803_body (Current)).it_r;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 955, Current, 0, 0, 14413);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(955, Current, 14413);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6711, 0xF8000466, 0); /* list_hidden_actions_internal */
...
static EIF_TYPED_VALUE F956_8806_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 955, Current, 0, 0, 14414);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(955, Current, 14414);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F956_8806 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6711, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F956_8806_body (Current)).it_r;
