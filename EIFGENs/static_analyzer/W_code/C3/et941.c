...
void F941_8711 (EIF_REFERENCE Current)
{
	...
	*(EIF_REFERENCE *)(Current + RTWA(6629, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6630, 0xF80005F0, 0); /* on_change */
...
#define ui4_1 ui4_1x.it_i4
	...
	RTCC(arg1, 940, l_feature_name, 1, eif_attached_type(1113));
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
#define up2 up2x.it_p
	...
	for (;;) {
		...
		RTNHOOK(2,1);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7971, "etf_cmd_routine", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
