...
extern void F941_8711(EIF_REFERENCE);
extern EIF_TYPED_VALUE F941_8712(EIF_REFERENCE);
extern EIF_TYPED_VALUE F941_8713(EIF_REFERENCE);
extern void F941_8714(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F941_8715(EIF_REFERENCE);
...
void F941_8711 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 940, Current, 0, 0, 14342);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(940, Current, 14342);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6629, 0xF80000F9, 0); /* commands */
	...
	*(EIF_REFERENCE *)(Current + RTWA(6629, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6630, 0xF800060C, 0); /* on_change */
	
	tr1 = RTLNSMART(eif_non_attached_type(RTWCT(6630, dtype, Dftype(Current))));
...
void F941_8714 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 940, Current, 0, 1, 14345);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(940, Current, 14345);
	RTCC(arg1, 940, l_feature_name, 1, eif_attached_type(1140));
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
	...
	RTNHOOK(1,1);
	ur1 = RTCCL(arg1);
	tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6629, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	RTNHOOK(1,2);
...
void F941_8715 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 940, Current, 1, 0, 14346);
	RTSA(Dtype(Current));
	RTSC;
	...
	for (;;) {
		...
		RTNHOOK(2,1);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8054, "etf_cmd_routine", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
