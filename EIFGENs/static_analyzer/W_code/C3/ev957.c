...
extern EIF_TYPED_VALUE F957_8802(EIF_REFERENCE);
extern EIF_TYPED_VALUE F957_8803(EIF_REFERENCE);
...
EIF_TYPED_VALUE F957_8802 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 956, Current, 0, 0, 14419);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(956, Current, 14419);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F957_8803 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 956, Current, 0, 0, 14420);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(956, Current, 14420);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800044C, 0,0); /* Result */
