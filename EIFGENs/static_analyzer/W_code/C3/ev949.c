...
extern EIF_TYPED_VALUE F949_8762(EIF_REFERENCE);
extern EIF_TYPED_VALUE F949_8763(EIF_REFERENCE);
...
EIF_TYPED_VALUE F949_8762 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 948, Current, 0, 0, 14389);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(948, Current, 14389);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F949_8763 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 948, Current, 0, 0, 14390);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(948, Current, 14390);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800044C, 0,0); /* Result */
