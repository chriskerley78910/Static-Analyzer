...
extern EIF_TYPED_VALUE F955_8793(EIF_REFERENCE);
...
EIF_TYPED_VALUE F955_8792 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 954, Current, 0, 0, 14411);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(954, Current, 14411);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F955_8793 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 954, Current, 0, 0, 14412);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(954, Current, 14412);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800043D, 0,0); /* Result */
...
EIF_TYPED_VALUE F955_8794 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 954, Current, 0, 0, 14413);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(954, Current, 14413);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F955_8795 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 954, Current, 0, 0, 14414);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(954, Current, 14414);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800043E, 0,0); /* Result */
