...
extern void F944_8744(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F944_8745(EIF_REFERENCE);
extern void F944_8746(EIF_REFERENCE);
extern void F944_8747(EIF_REFERENCE);
extern EIF_TYPED_VALUE F944_8748(EIF_REFERENCE);
...
void F944_8744 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 943, Current, 0, 4, 14373);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(943, Current, 14373);
	RTCC(arg1, 943, l_feature_name, 1, eif_attached_type(219));
	RTCC(arg2, 943, l_feature_name, 2, eif_attached_type(219));
	{
		static EIF_TYPE_INDEX typarr0[] = {403,0xFF11,1050,0xFFFF};
	...
	ur2 = RTCCL(arg2);
	ub1 = arg4;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(6633, dtype))(Current, ur1x, ur2x, ub1x);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6663, 0xF8000193, 0); /* test_classes */
	
	RTAR(Current, arg3);
	*(EIF_REFERENCE *)(Current + RTWA(6663, dtype)) = (EIF_REFERENCE) RTCCL(arg3);
	RTHOOK(3);
...
void F944_8745 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 14374);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6635, dtype))(Current, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 943, Current, 5, 0, 14375);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6655, 0x10000000, 1); /* number_of_boolean */
	
	*(EIF_INTEGER_32 *)(Current + RTWA(6655, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6656, 0x10000000, 1); /* number_passed_boolean */
	
	*(EIF_INTEGER_32 *)(Current + RTWA(6656, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(4);
	RTDBGAA(Current, dtype, 6657, 0x10000000, 1); /* number_of_violation */
	
	*(EIF_INTEGER_32 *)(Current + RTWA(6657, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(5);
	RTDBGAA(Current, dtype, 6658, 0x10000000, 1); /* number_passed_violation */
	
	*(EIF_INTEGER_32 *)(Current + RTWA(6658, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(6);
	RTDBGAA(Current, dtype, 6659, 0x10000000, 1); /* number_of_tests */
	
	*(EIF_INTEGER_32 *)(Current + RTWA(6659, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(7);
	RTDBGAA(Current, dtype, 6660, 0x10000000, 1); /* number_passed_tests */
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			...
			for (;;) {
				...
				RTHOOK(16);
				tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7308, "is_violation_case", loc5))(loc5)).it_b);
				
				if (tb3) {
					RTHOOK(17);
					tb3 = *(EIF_BOOLEAN *)(loc5 + RTVA(7311, "passed", loc5));
					...
					(*(EIF_INTEGER_32 *)(Current + RTWA(6655, dtype)))++;
				}
				RTHOOK(25);
				RTDBGAA(Current, dtype, 6659, 0x10000000, 1); /* number_of_tests */
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 943, Current, 6, 0, 14376);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
			...
			if ((EIF_TRUE)) {
				...
				if (EIF_TEST(loc6)) {
					...
					for (;;) {
						...
						ur1 = RTCCL(tr1);
						(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6648, dtype))(Current, ur1x);
						RTHOOK(18);
...
EIF_TYPED_VALUE F944_8748 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
