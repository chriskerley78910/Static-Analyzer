...
#define ub1 ub1x.it_b
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {403,0xFF11,1048,0xFFFF};
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			...
			for (;;) {
				...
				RTHOOK(16);
				tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7263, "is_violation_case", loc5))(loc5)).it_b);
				
				if (tb3) {
					RTHOOK(17);
					tb3 = *(EIF_BOOLEAN *)(loc5 + RTVA(7266, "passed", loc5));
