...
extern EIF_TYPED_VALUE F952_8772(EIF_REFERENCE);
static EIF_TYPED_VALUE F952_8774_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F952_8774(EIF_REFERENCE);
extern EIF_TYPED_VALUE F952_8775(EIF_REFERENCE);
static EIF_TYPED_VALUE F952_8777_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F952_8777(EIF_REFERENCE);
...
EIF_TYPED_VALUE F952_8772 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 951, Current, 0, 0, 14400);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(951, Current, 14400);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6684, 0xF800044C, 0); /* select_actions_internal */
...
static EIF_TYPED_VALUE F952_8774_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 951, Current, 0, 0, 14397);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(951, Current, 14397);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F952_8774 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6684, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F952_8774_body (Current)).it_r;
...
EIF_TYPED_VALUE F952_8775 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 951, Current, 0, 0, 14398);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(951, Current, 14398);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 6687, 0xF800044C, 0); /* deselect_actions_internal */
...
static EIF_TYPED_VALUE F952_8777_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 951, Current, 0, 0, 14399);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(951, Current, 14399);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F952_8777 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6687, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F952_8777_body (Current)).it_r;
