...
static EIF_TYPE_INDEX gen_type13_1131 [] = {0xFF11,1200,0xFFFF};
static EIF_TYPE_INDEX gen_type14_1131 [] = {0xFF11,219,0xFFFF};
...
static struct desc_info desc_1131[] = {
	...
	{16102, (BODY_INDEX)-1, 1200, gen_type13_1131},
	{16103, (BODY_INDEX)-1, 190, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 219, gen_type14_1131},
};
...
void Init1131(void)
{
	...
	IDSC(desc_1131 + 32, 601, 1130);
	IDSC(desc_1131 + 33, 1043, 1130);
}
